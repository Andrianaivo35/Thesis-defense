...
/* contient uniquement le logo image (plus de texte a cote) */
...
/* logo image centre, seul (le nom est deja dans l'image) */
...
export const StudentMenu = styled.nav`
  display: flex;
  flex-direction: column;
  gap: 4px;
  flex: 1;
...
export const StudentMenuLink = styled.button`
