...
export const CompanySidebar = styled.aside`
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
...
export const CompanyMenu = styled.nav`
  display: flex;
  flex-direction: column;
  gap: 4px;
  flex: 1;
...
export const CompanyMenuLink = styled.button`
...
export const CompanyLogoutButton = styled.button`
  background: white;
  color: #dc2626;
