...
/* ===== SECTION PHOTO (contour seul, plus de fond plein) ===== */
...
export const PhotoControls = styled.div`
  ...
  @media (max-width: 640px) { width: 100%; align-items: center; }
`

/* les deux boutons cote a cote */
...
export const PhotoUploadLabel = styled.label`
  ...
  &:hover {
    ...
    box-shadow: 0 7px 16px rgba(169, 139, 118, 0.35);
  }
`

/* ===== CARTE D'ITEM (parcours, intérêt) ===== */
...
export const ItemBadge = styled.span`
  ...
  gap: 5px;
  padding: 4px 11px;
  background: ${p => p.$isNew ? '#f5e6d1' : '#eef0d9'};
  color: ${p => p.$isNew ? '#8a5a20' : '#4d5e2c'};
  border-radius: 6px;
  font-size: 12.5px;
  font-weight: 700;
`
