...
/* ============================================================
   ...
   Style aligné sur celui de l'espace entreprise : les deux écrans
   de connexion sont la même étape du même parcours, ils n'ont
   aucune raison de se présenter différemment.
   ============================================================ */
...
/* styled.button et non styled.input comme côté entreprise : la page
   université passe son libellé en contenu enfant ({isLoading ? ... })
   et non par l'attribut value. Le rendu visuel est identique, seule
   la balise change. */
...
/* cursor: pointer explicite — ces liens n'ont pas de href ici, ils
   naviguent par onClick, et un <a> sans href n'affiche pas la main. */
